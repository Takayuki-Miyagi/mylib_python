...
if(__name__=="__main__"):
    print(mu_sp(4,4.5,-1))
    print(np.sqrt(Rp2_to_Rch2(9.96714003-0.10123522, 20, 28)))
    print(np.sqrt(Rp2_to_Rch2(10.10296704-0.11810776, 20, 32)))
    print(np.sqrt(Rp2_to_Rch2(10.21467325-0.10123522, 20, 34)))
    #print(mu_sp(1,1.5,1))
    #print(Q_sp(3.5,25))
